...
export default function Login() {
  ...
  return (
    <div className="bg-gray-100 flex items-center justify-center min-h-screen">
      ...
      <div className="flex flex-col items-center max-w-4xl w-full space-y-8">
        <div className="flex flex-row items-center bg-white shadow-2xl rounded-lg p-8 w-full space-x-8">
          {/* User Logo */}
