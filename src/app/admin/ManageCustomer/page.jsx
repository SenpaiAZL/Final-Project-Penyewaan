      ...
      <main className="flex-grow container mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {customers?.map((customer) => (
            <div
              key={customer.pelanggan_id || customer.pelanggan_email} // Gunakan ID atau email sebagai key
            ...
            >
              ...
              <p className="text-gray-700">Alamat: {customer.pelanggan_alamat}</p>
              <p className="text-gray-700">No. Telepon: {customer.pelanggan_notelp}</p>
