...
export default function Card({ alat, onClick }) {
  return (
    ...
    >
      ...
      <p className="text-gray-600">Harga sewa : {alat.alat_hargaperhari}</p>
      <p className="text-gray-600 mt-2">Stok Alat : {alat.alat_stok}</p>
      <p className="text-gray-600 mt-2">Deskripsi : {alat.alat_deskripsi}</p>
      <p className="text-gray-600 mt-2">{alat.alat_kategori}</p>
    </div>
  );
}
